...
class VersionManager:
    ...
    def install_chrome(self, version):
        try:
            if version:
                chrome_download_url = "https://mirror.cs.uchicago.edu/google-chrome/pool/main/g/google-chrome-stable/google-chrome-stable_127.0.6533.72-1_amd64.deb"  # https://mirror.cs.uchicago.edu/google-chrome/pool/main/g/google-chrome-stable/google-chrome-stable_114.0.5735.90-1_amd64.deb
                chrome_installer_path = "google-chrome-stable_127.0.6533.72-1_amd64.deb"
