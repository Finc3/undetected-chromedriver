        ...
        try:
            ...
            if os.getenv("USE_MAC_QUEUE") == "true":
                ...
                if version:
                    ...
                    chrome_download_url = "https://mirror.cs.uchicago.edu/google-chrome/pool/main/g/google-chrome-stable/google-chrome-stable_132.0.6834.83-1_amd64.deb"
                    subprocess.run(["wget", chrome_download_url])
                    subprocess.run(["dpkg", "--configure", "-a"])
                    result = subprocess.run(["apt", "install", "-y", "./google-chrome-stable_132.0.6834.83-1_amd64.deb"])
                    os.remove("google-chrome-stable_132.0.6834.83-1_amd64.deb")
